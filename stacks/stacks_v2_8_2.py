# -*- coding: utf-8 -*-
"""
枚数検知センサシステム 制御プログラム (Ver 2.8.2)

v2.8.1 ベース:
- ENABLE_MODE_SWITCH を mode_switch.conf から読み込む（コード直編集不要）
- 既定 conf / ファイル無しは false（v2.8.0 相当）
- 変更反映には stacks.service の再起動が必要（制御パネルのトグルが実施）
"""
...
def initialize_runtime():
    ...
    bind_handlers()
    logging.info("==============================================")
    logging.info(" 枚数検知監視 プログラムVer 2.8.2 (自動復帰 + conf切替フラグ) ")
